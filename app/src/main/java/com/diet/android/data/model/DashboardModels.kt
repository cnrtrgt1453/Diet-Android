...
data class DailyLog(
    ...
    @SerializedName("waterIntakeMl") val waterIntakeMl: Double = 0.0,
    val physicalActivityMinutes: Int = 0,
    val calorieIntake: Int = 0,
    val note: String? = null,
    @SerializedName("glp1SideEffectLevel") val sideEffectLevel: Int? = null,
    @SerializedName("glp1NauseaSeverity") val glp1Nausea: Int? = null,
    @SerializedName("glp1ConstipationSeverity") val glp1Constipation: Int? = null,
    @SerializedName("glp1DiarrheaSeverity") val glp1Diarrhea: Int? = null,
    val glp1Vomiting: Boolean? = null,
    val glp1InjectionSite: String? = null,
    @SerializedName("glp1SideEffects") val sideEffectsList: String? = null,
    @SerializedName("lipedemaPainLevel") val painLevel: Int? = null,
    val lipedemaPainLevelVas: Int? = null,
    @SerializedName("glutenFreeCompliant") val glutenFree: Boolean? = null,
    @SerializedName("sugarFreeCompliant") val sugarFree: Boolean? = null,
    @SerializedName("dairyFreeCompliant") val dairyFree: Boolean? = null,
    @SerializedName("processedFoodFreeCompliant") val processedFoodFree: Boolean? = null,
    @SerializedName("alcoholFreeCompliant") val alcoholFree: Boolean? = null,
    @SerializedName("currentHormonalPhase") val hormonalPhase: String? = null,
    val fastingBloodGlucose: Double? = null,
    val insulinLevel: Double? = null,
    val cycleDay: Int? = null,
    @SerializedName("insulinCravingLevel") val insulinCraving: Int? = null
)
